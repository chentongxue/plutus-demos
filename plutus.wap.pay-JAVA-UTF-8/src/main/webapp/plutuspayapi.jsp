...
<%@ page import="cn.kdfa.config.PlutusConfig"%>
<%@ page import="java.util.HashMap"%>
<%@ page import="java.util.Map"%>
<%@ page import="cn.kdfa.config.PlutusConfig" %>
<%@ page import="cn.kdfa.util.PlutusSubmit" %>
<!DOCTYPE html>
<html>
	<head>
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<title>中娱互动支付手机网站支付接口</title>
	</head>
	<%
		////////////////////////////////////请求参数//////////////////////////////////////
		System.out.println(request.getParameter("trade_no"));
		System.out.println(request.getParameter("total_fee"));
		System.out.println(new String(request.getParameter("subject").getBytes("ISO-8859-1"),"UTF-8"));
		System.out.println(request.getParameter("pay_type"));
		...
		sParaTemp.put("app_id", PlutusConfig.app_id);
        sParaTemp.put("timestamp", PlutusConfig.timestamp);
        sParaTemp.put("trade_no",out_trade_no);
        sParaTemp.put("subject", subject);
		sParaTemp.put("total_fee",total_fee);
		sParaTemp.put("body", body);
		sParaTemp.put("signature", PlutusConfig.signature);
		...
		//建立请求
		String sHtmlText = PlutusSubmit.buildRequest(sParaTemp, "post", "queren", pay_type);
